...
subtitle: "&nbsp;&nbsp;\u2694 <br/>with xaringan and xaringanthemer<br/>plus kunoichi and ninjutsu"  
author: "Yihui Xie"
date: '2018/09/19'
output:
  xaringan::moon_reader:
    lib_dir: libs
    css: ["xaringan-themer.css", "ninjutsu", "kunoichi"] 
    nature:
...
.column.bg-main4.white[.content[
# A .yellow[kunoichi] can use .yellow[ninjutsu] to .white[split columns] easily.
<br>
...
# See more about this feature [here](https://github.com/emitanaka/ninja-theme).
]]
