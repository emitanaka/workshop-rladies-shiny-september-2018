...
subtitle: ""
author: "Emi Tanaka&nbsp;&nbsp;&nbsp;`r anicon::faa('twitter', animate='float', rtext='&nbsp;@statsgen')`"
date: "<br>2018/09/19<br>`r anicon::faa('link', animate='vertical', rtext='&nbsp;bit.ly/rladies-sydney-shiny', color='yellow')`"
output:
