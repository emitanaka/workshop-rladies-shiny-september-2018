---
title: "Shiny September: Making an interactive web app with R"
subtitle: ""
author: "Emi Tanaka"
date: "<br>2018/09/19<br><br>"
output:
...
anicon::faa('link', animate='vertical', rtext='&nbsp;bit.ly/rladies-sydney-shiny', color='yellow')
```
...
at the .Rmd files <a href="https://github.com/emitanaka">here</a>.</span><br><br>
...
* You will get a template with the geyser histogram example. Go to either ui.R, server.R or app.R. There should be `Run App` appear in the upper right corner of the editor window in RStudio.
...
* To learn more about it, see the documentation [here]().
...
* To see you waiting screen, you can use `Sys.sleep(10)` to pause the computation for 10 seconds (don't do it in practice of course)!
